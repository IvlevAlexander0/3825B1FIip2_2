...
public:
	...
	//Арифметические операции (и вывод) через перегрузку оперторов.(Некоторые крайние случаи можно оптимизировать. Например сумму и разность дробей с одинаковым числителем.)
